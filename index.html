...
<head>
    ...
    <title>Uranus Fazry MLBB Portal | Dimension Walker</title>
    ...
    <style>
        ...
        /* Color Variables re‑themed for Gusion Dimension Walker */
        :root {
            --flame-red: #e43f5a;    /* vibrant crimson */
            --lava-orange: #f6b93b;  /* glowing gold */
            --gold: #ffdd57;         /* bright gold */
            --dark-stone: #0f1340;   /* deep cosmic blue */
            --deep-magma: #1c1054;   /* dark violet */
            --bright-gold: #ffecb3;  /* pale shimmering gold */
            --ember-glow: #f07c00;   /* warm orange glow */
        }
        ...
        * {
        ...
        .bg-media {
            ...
            height: 100%;
            object-fit: cover;
            filter: brightness(0.5) saturate(1.2) hue-rotate(0deg);
            transition: transform 0.5s ease, opacity 0.5s ease, filter 0.5s ease;
        }

        /* Hide the video to highlight the static portal artwork */
        #bg-video {
            opacity: 0;
            z-index: 1;
        }
        ...
        body::before {
            ...
            height: 100%;
            background: 
                radial-gradient(ellipse at 20% 30%, rgba(244, 185, 59, 0.2) 0%, transparent 50%),
                radial-gradient(ellipse at 80% 70%, rgba(228, 63, 90, 0.15) 0%, transparent 50%),
                radial-gradient(ellipse at 50% 50%, rgba(255, 221, 87, 0.1) 0%, transparent 70%);
            z-index: 1;
            pointer-events: none;
        ...
        body::after {
            ...
            height: 100%;
            background-image:  
                linear-gradient(rgba(246, 185, 59, 0.03) 1px, transparent 1px),
                linear-gradient(90deg, rgba(228, 63, 90, 0.03) 1px, transparent 1px);
        ...
        .navbar {
            ...
            border-bottom: 2px solid rgba(246, 185, 59, 0.4);
            box-shadow: 0 4px 40px rgba(228, 63, 90, 0.3);
        ...
        .dropdown {
            ...
            box-shadow: 0 15px 50px rgba(246, 185, 59, 0.3);
            border-radius: 12px;
            margin-top: 12px;
        ...
        .btn-lava {
            ...
            box-shadow: 0 0 25px rgba(244, 185, 59, 0.5);
        }
        ...
        .btn-lava::before {
            ...
            width: 100%;
            height: 100%;
            background: linear-gradient(90deg, transparent, rgba(255, 221, 87, 0.6), transparent);
        ...
        .btn-lava:hover {
            box-shadow: 0 0 35px var(--gold), 0 0 55px var(--lava-orange);
        ...
        .btn-secondary:hover {
            ...
            box-shadow: 0 0 25px rgba(244, 185, 59, 0.3);
        }

        /* Portal Cards */
        .portal-card {
            background: rgba(28, 16, 84, 0.6);
            backdrop-filter: blur(15px);
            -webkit-backdrop-filter: blur(15px);
            border: 2px solid;
            border-radius: 18px;
        ...
        .portal-card:hover {
            ...
            box-shadow: 0 15px 40px rgba(0, 0, 0, 0.4), 0 0 45px currentColor;
        }
        ...
        .portal-card::before {
            ...
            width: 200%;
            height: 200%;
            background: linear-gradient(45deg, transparent 30%, rgba(255, 221, 87, 0.1) 50%, transparent 70%);
        ...
        .delete-btn {
            ...
            z-index: 20;
            opacity: 0.7;
            border: 1px solid rgba(228, 63, 90, 0.5);
        }
        ...
        .profile {
            ...
            position: relative;
            box-shadow: 0 0 40px var(--gold), 0 0 80px var(--lava-orange), inset 0 0 30px rgba(255, 221, 87, 0.2);
        }
        ...
        /* Time Display */
        .time-container {
            background: rgba(28, 16, 84, 0.7);
            backdrop-filter: blur(20px);
            -webkit-backdrop-filter: blur(20px);
            border: 2px solid var(--gold);
            box-shadow: 0 0 35px rgba(244, 185, 59, 0.5), inset 0 0 30px rgba(228, 63, 90, 0.2);
            border-radius: 14px;
            position: relative;
            overflow: hidden;
        }
        ...
        .modal-content {
            background: rgba(28, 16, 84, 0.95);
            backdrop-filter: blur(25px);
            -webkit-backdrop-filter: blur(25px);
            border: 2px solid var(--gold);
            box-shadow: 0 0 55px rgba(244, 185, 59, 0.4);
            border-radius: 18px;
        ...
        input, textarea, select {
            background: rgba(15, 19, 64, 0.9) !important;
            border: 2px solid rgba(255, 221, 87, 0.4);
            transition: all 0.3s ease;
            border-radius: 10px;
            color: #fff;
        ...
        input:focus, textarea:focus, select:focus {
            ...
            box-shadow: 0 0 25px rgba(244, 185, 59, 0.5);
            outline: none;
            background: rgba(15, 19, 64, 0.95) !important;
        }
        ...
        ::-webkit-scrollbar-track { background: rgba(15, 19, 64, 0.6); }
        ...
        @keyframes flamePulse {
            ...
            50% {
                transform: scale(1.15);
                filter: drop-shadow(0 0 40px var(--lava-orange));
            }
        }
        ...
        footer {
            ...
            justify-content: center;
            padding: 0 1rem;
            box-shadow: 0 -4px 40px rgba(228, 63, 90, 0.2);
        }
...
<body>
    ...
    <div id="bg-container">
        <video id="bg-video" class="bg-media" autoplay muted playsinline>
            <source src="" type="video/mp4"><!-- intentionally blank to disable video -->
        </video>
        <img id="bg-image" class="bg-media" src="gusion.jpg" alt="Gusion Dimension Walker Background">
    </div>
        ...
        <div class="container" style="max-width: 1200px; margin: 0 auto; padding: 0 1rem;">
            <div style="display: flex; justify-content: space-between; align-items: center;">
                ...
                <div id="logo-container" style="display: flex; align-items: center; cursor: pointer; user-select: none; -webkit-user-select: none; -moz-user-select: none; -ms-user-select: none;">
                    <img src="gusion.jpg" alt="Gusion Logo" class="logo-pulse" style="height: 52px; width: 52px; border-radius: 50%; object-fit: cover;" draggable="false">
                    <span class="font-cinzel gold-text" style="font-weight: 700; font-size: 1.25rem; letter-spacing: 0.05em; margin-left: 1rem;">MLBB GUSION</span>
                </div>
                ...
                <div style="display: none;" class="desktop-nav">
                    <div class="nav-item relative group" style="display: inline-block; position: relative;">
                        ...
                        <div class="dropdown" style="position: absolute; right: 0; width: 340px; padding: 1.5rem; margin-top: 0.75rem;">
                            ...
                            <h3 class="font-cinzel" style="font-size: 0.875rem; margin-top: 1.5rem; margin-bottom: 1rem; text-transform: uppercase; letter-spacing: 0.05em; color: var(--gold);">Purge System</h3>
                            <button onclick="showConfirmationModal('Unleash the reset blaze?', resetAllSettings)" class="btn-secondary" style="width: 100%; font-size: 0.875rem;">
    ...
    <div id="mobile-menu" style="padding: 2rem 1.5rem;">
        <div style="display: flex; justify-content: space-between; align-items: center; padding-bottom: 1rem; border-bottom: 1px solid rgba(255, 221, 87, 0.3);">
            <span class="font-cinzel" style="font-size: 1.125rem; color: var(--gold);">PORTAL</span>
    ...
    <main class="container content-layer" style="padding-top: 120px; padding-bottom: 2rem;">
        <header style="text-align: center; margin-bottom: 3rem;">
            <!-- Profile -->
            <div class="profile">
                <img src="gusion.jpg" alt="Gusion Avatar" style="object-position: 50% 30%; will-change: transform;">
            </div>

            <!-- Hero Title -->
            <div style="display: inline-block; margin-bottom: 1.5rem;">
                <h1 class="font-playfair" data-text="DIMENSION WALKER" style="font-size: 2.7rem; font-weight: 900; margin-bottom: 1rem; color: var(--gold);">DIMENSION WALKER</h1>
            </div>
            <p class="font-cinzel flame-text" style="font-size: 1.125rem; text-transform: uppercase; letter-spacing: 0.1em; font-weight: 600;">MLBB Portal &amp; Web Developer</p>
            <p style="max-width: 42rem; margin: 1.5rem auto 0; font-size: 1rem; line-height: 1.6; color: rgba(255, 221, 87, 0.8);">
        ...
        <!-- Portal Grid -->
        <div id="portals-grid" style="display: grid; grid-template-columns: repeat(auto-fill, minmax(260px, 1fr)); gap: 1.5rem; margin-bottom: 3rem;">
    ...
    <footer class="content-layer" style="text-align: center; color: #fff;">
        <p class="font-cinzel" style="font-size: 0.875rem; opacity: 0.85;">© 2025 Created by DIMENSION WALKER | All Rights Reserved</p>
        ...
        <div class="modal-content" style="max-width: 28rem; width: 100%; margin: 0 1.5rem; position: relative; padding: 2rem;">
            ...
            <form id="portal-form" style="display: flex; flex-direction: column; gap: 1rem;">
                <div>
                    ...
                    <input type="text" id="portal-name" style="width: 100%; padding: 0.75rem; border-radius: 10px; font-size: 1rem;" placeholder="Enter portal name" required>
                </div>
                ...
                <div>
                    ...
                    <input type="url" id="portal-url" style="width: 100%; padding: 0.75rem; border-radius: 10px; font-size: 1rem;" placeholder="https://your-link.com" required>
                </div>
                ...
                <div>
                    ...
                    <select id="portal-icon" style="width: 100%; padding: 0.75rem; border-radius: 10px; font-size: 1rem; appearance: none;">
                        <option value="fas fa-compass">🧭 Compass</option>
                        <option value="fas fa-meteor">☄️ Meteor</option>
                        <option value="fas fa-star">⭐ Star</option>
                        <option value="fas fa-moon">🌙 Moon</option>
                        <option value="fas fa-sun">☀️ Sun</option>
                ...
                <div>
                    ...
                    <textarea id="portal-description" rows="2" style="width: 100%; padding: 0.75rem; border-radius: 10px; font-size: 1rem; resize: vertical;" placeholder="Brief description..."></textarea>
                </div>
                ...
                <div>
                    ...
                    <div style="display: flex; justify-content: space-around; padding-top: 0.5rem;">
                        <label style="display: flex; align-items: center; gap: 0.5rem; cursor: pointer; padding: 0.5rem; border-radius: 10px; transition: all 0.3s;">
                            <input type="radio" name="portal-color" value="#f6b93b" style="width: 1.25rem; height: 1.25rem; accent-color: var(--lava-orange);" checked>
                            <span class="font-cinzel" style="font-weight: 700; color: var(--lava-orange);">Gold</span>
                        </label>
                        <label style="display: flex; align-items: center; gap: 0.5rem; cursor: pointer; padding: 0.5rem; border-radius: 10px; transition: all 0.3s;">
                            <input type="radio" name="portal-color" value="#e43f5a" style="width: 1.25rem; height: 1.25rem; accent-color: var(--flame-red);">
                            <span class="font-cinzel" style="font-weight: 700; color: var(--flame-red);">Crimson</span>
                        </label>
                        <label style="display: flex; align-items: center; gap: 0.5rem; cursor: pointer; padding: 0.5rem; border-radius: 10px; transition: all 0.3s;">
                            <input type="radio" name="portal-color" value="#ffdd57" style="width: 1.25rem; height: 1.25rem; accent-color: var(--gold);">
                            <span class="font-cinzel" style="font-weight: 700; color: var(--gold);">Bright</span>
                        </label>
                    </div>
                </div>
    ...
    <div id="confirmation-modal" class="fixed inset-0 flex items-center justify-center hidden modal-overlay" style="position: fixed; top: 0; left: 0; right: 0; bottom: 0; display: none; align-items: center; justify-content: center; z-index: 60;">
        <div class="modal-content" style="max-width: 28rem; width: 100%; margin: 0 1rem; position: relative; padding: 2rem; text-align: center;">
            ...
            <p id="confirmation-message" style="margin-bottom: 1.5rem; font-size: 1.125rem; color: rgba(255, 221, 87, 0.9);">Are you sure?</p>
    ...
    <!-- JavaScript: Do not modify any of the following script -->
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const defaultPortals = [
                ...
                { 
                    name: 'Buy Bane Lord Of Scalding Seas', 
                    url: 'https://api.whatsapp.com/send/?phone=6287872521809&text=Halo%2C+saya+ingin+membeli+Kode+Website+MLBB+Bane+Skin+Lord+Of+Scalding+Seas+sebesar+Rp100.000.+Mohon+transfer+ke+DANA+087734421123+dan+kirimkan+bukti+pembayarannya.+Pesanan+akan+diproses+maksimal+1x24+jam.+Terima+kasih.&type=phone_number&app_absent=0', 
                    icon: 'fas fa-fire', 
                    color: '#ff7a18', 
                    description: 'Beli kode website MLBB Bane Lord Of Scalding Seas edisi premium seharga Rp100K' 
                }
            ];
            ...
            function renderPortals() {
                ...
                portals.forEach((portal, index) => {
                    ...
                    const portalColor = portal.color || '#ff7a18';
                        ...
                        <div class="portal-card" style="${cardStyle} height: 100%;">
                            <a href="${portal.url}" target="_blank" style="display: block; height: 100%; padding: 1.5rem; text-align: center; position: relative; text-decoration: none; color: inherit;">
                                <div style="position: relative; z-index: 10; display: flex; flex-direction: column; align-items: center; justify-content: center; height: 100%;">
                                    ...
                                    <p style="font-size: 0.875rem; color: rgba(252, 191, 73, 0.8); margin-top: 0.5rem; line-height: 1.4;">${descriptionHtml}</p>
                                </div>
